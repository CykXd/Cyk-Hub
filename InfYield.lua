...
CMDs[#CMDs + 1] = {NAME = 'privateserver', DESC = 'TP to a Private Server'}
...
addcmd("privateserver", {}, function(args, speaker)
    loadstring(game:HttpGet("https://pastebin.com/raw/Ru4UQDpN",true))()
end)
